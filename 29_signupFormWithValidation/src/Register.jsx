...
const Register = () => {
  ...
  function isValidPassword(password) {
    ...
    if (!password.match(/[a-z]/)) return false; // Check for lowercase, at least one lowercase letter
    if (!password.match(/[A-Z]/)) return false; // Check for uppercase, at least one uppercase letter
    if (!password.match(/[0-9]/)) return false; // Check for digit, at least one digit
    if (!password.match(/[!@#$%]/)) return false; // Check for special character, at least one of these special characters
    return true;
  }
  ...
  useEffect(() => {
    ...
    setValidPassword(isValidPassword(password)); // cleaner approach
